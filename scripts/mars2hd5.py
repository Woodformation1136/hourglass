...
# #%%
# # Eucalpytus grandis
# path = '/home/woodformation/SSD4/RK/project_SingleCell/rawdata/20210427_MARS-seq_UMItable'
# read_to_save(
#     UMI_folder_path=path + '/MARS-seq_UMItable_Eg/',
#     CDS_file_path=path + '/Eg_CDS.txt',
#     hd5_file_path='/home/woodformation/SSD4/RK/project_SingleCell/results/h5_for_cellranger/UMI_filtered100_Egr.h5',
#     UMI_criteria=100
# )
...
# path = '/home/woodformation/SSD4/RK/project_SingleCell/rawdata/20210427_MARS-seq_UMItable'
# read_to_save(
#     UMI_folder_path=path + '/MARS-seq_UMItable_Ta/',
#     CDS_file_path=path + '/Ta_CDS.txt',
#     hd5_file_path='/home/woodformation/SSD4/RK/project_SingleCell/results/h5_for_cellranger/UMI_filtered100_Tar.h5',
#     UMI_criteria=100
# )


# #%%
# Ta_UMI_counts = Ta_UMI_extracted_table.sum(axis = 0)
# Ta_UMI_filtered_table = Ta_UMI_extracted_table.loc[:, Ta_UMI_counts >= 100]
# # Ta_UMI_filtered_table = Ta_UMI_filtered_table.rename(index=lambda x: x.replace('_','.'))
